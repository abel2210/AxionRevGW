...
POWER_SPECTRUM_LABELS = {
    "highfre transition radiation": r"$\left|300\right\rangle\rightarrow\left|322\right\rangle$",
    "highfre644 transition radiation": r"$\left|544\right\rangle\rightarrow\left|644\right\rangle$",
}
...
EXPORT_TARGETS = (
    ExportTarget(
        ...
        path=FREQUENCY_DATA_DIR / "highfre322_axion_frequency_amplitude.txt",
        builder_name="highfre",
    ),
    ExportTarget(
        label="highfre644 transition radiation",
        path=FREQUENCY_DATA_DIR / "highfre644_axion_frequency_amplitude.txt",
